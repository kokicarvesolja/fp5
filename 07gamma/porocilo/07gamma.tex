...
\usepackage{hyperref}
\usepackage{amsmath}
\renewcommand{\theta}{\vartheta} \renewcommand{\phi}{\varphi}
\author{Kristofer Robin}
\date{\today}
\title{07 Spektrometrija žarkov \(\gamma\) s scintilacijskim spektrometrom}
\hypersetup{
 pdfauthor={Kristofer Robin},
 pdftitle={07 Spektrometrija žarkov \(\gamma\) s scintilacijskim spektrometrom},
 pdfkeywords={},
 pdfsubject={},
...
\end{enumerate}
\section{Izračuni in obdelava}
\label{sec:org8f92a5e}
...
\subsection{Enokanalne meritve}
\label{sec:orgb677120}
...
\end{center}
\subsection{Umeritev energijske skale}
\label{sec:orgb47b656}
...
\end{center}
\subsection{Šum ozadja}
\label{sec:org39e42a5}
...
\end{center}
\subsection{Spekter \(^{22} \mathrm{Na}\)}
\label{sec:org0586687}
...
\end{align*}
\subsection{Spekter \(^{60} \mathrm{Co}\)}
\label{sec:org51e535e}
...
\end{align*}
\subsection{Spekter \(^{137} \mathrm{Cs}\)}
\label{sec:org8835c43}
...
\end{align*}
\subsection{Energijska ločljivost}
\label{sec:orgfb9b95f}
...
\end{align*}
\subsection{Ocena izkoristka}
\label{sec:orgb8fc457}
